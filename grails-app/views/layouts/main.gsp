...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="<g:resource dir="js/jquery-ui-1.11.2" file="jquery-ui.theme.min.css" />" type="text/css">
		<g:javascript src="jquery-ui-1.11.2/jquery-ui.min.js" />
